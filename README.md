...
- **SENIOR BACKEND DEVELOPER**
  ...
  - Stack: Go, Python, Java, open API, Docker, Kubernetes, PostgreSQL, Redis, Argo-workflow, Terraform, and Github Workflow.
...
- **BACKEND DEVELOPER**
  ...
  - Used standard Google OAuth 2.0 framework to allow merchants to signup and login to Razorpay’s Dashboard
